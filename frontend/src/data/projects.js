const projects = [
    ...
    },
    {
        ...
        image: '/images/weather-app-preview.svg',
        skills: ['JavaScript', 'React'],
        tools: ['Vite', 'API', 'Hooks'],
    ...
    },
    {
        ...
        image: '/images/shopping-center-preview.svg',
        skills: ['JavaScript', 'React'],
        tools: ['Context API', 'Router', 'Cart Logic'],
    ...
    },
    {
        ...
        image: '/images/capstone-preview.svg',
        skills: ['JavaScript', 'React'],
        tools: ['Node.js', 'Express', 'MongoDB', 'JWT'],
        liveUrl: 'https://capstone-project-tljz.onrender.com/',
        githubUrl: 'https://github.com/studentzero68-collab/Capstone-project-.git',
        featured: false,
        caseStudy: {
    ...
    },
    {
        ...
        image: '/images/urban-threads-preview.svg',
        skills: ['JavaScript'],
        tools: ['Firebase', 'Firestore', 'Authentication'],
        liveUrl: 'https://studentzero68-collab.github.io/Urban-Threads/',
        githubUrl: 'https://github.com/studentzero68-collab/Urban-Threads.git',
        featured: false,
        caseStudy: {
